...
              Auftragsplanung: "Planification des projets",
              Gesamt: "total",
              Damen: "femmes",
              Herren: "hommes",
              Kinder: "enfants",
              Kaufteildisposition: "disposition de partie d’achat",
              Upload: "upload",
              Kapazitaetsplanung: "planification de capacité",
              Download:"export",
              Settings:"paramètres",
              TippsundTricks:"conseils et astuces",
              Metriken:"metrics",
              Speichern:"sauvegarder",
              Reset: "réinitialiser",
              NumericError: "seuls les nombres sont autorisés",
              TitelDamen: " planification de projet vélos femmes",
              TitelHerren: " planification de projet vélos hommes",
              TitelKinder: " planification de projet vélos enfants",
              TitelGesamt: "planification de projet total",
              Next: "plus",
              Back: "retour",
              DamenFahrrad:"vélos pour femmes",
              HerrenFahrrad:"vélos pour hommes",
              KinderFahrrad:"vélos pour enfants",
              Artikel:"article",
              Vertriebswunsch:"souhait de vente",
              BedarfWS: "demande de WS",
              GeplanterLagerbestand: "stock prévu",
              AktuellerLagerbestand: "stock actuel",
              Warteschlange: "files d’attentes",
              Bearbeitung: "traitement",
              Aufträge:"commandes",
              ErrorSaveNumeric: "S'il vous plaît, veuillez vous assurer que toutes les entrées se composent de numéros !",
              ErrorSavePeriod: "veuillez sélectionner une période, s’il vous plaït",
              ErrorKleinerDrei: "max. 3 couches possibles!",
              Lagerbestand: "stock prévu",
              Prognose: "prognostic",
              ProduktionFürAufträge: "production pour les commandes",
              ProduktionFürLager: "production pour les stocks",
              ProduktionGesamt: "production total",
              Summe: "sommes",
              Willkommen: "bienvenue à l’outil pss du groupe ZweiRad!",
              Starten: "Initialisation du flux de travail",
              DropFile: "importation du fichier –XML par Drag & Drop",
              Bezeichnung: "désignation",
              TeileArt: "type de produit",
              SachNR: "numéro de référence",
              Auftragsmenge: "montant de la commande",
              Arbeitsplatz: "espace de travail",
              Hinterrad:"roue arrière",
              Vorderrad: "roue avant",
              SchutzblechHinten: "garde-boue arrière",
              SchutzblechVorne: "garde-boue avant",
              Lenker: "guidon",
              Sattel: "selle",
              Rahmen: "cadre",
              Pedale: "pédales",
              VorderradKomplett: "roue avant complet",
              RahmenUndRäder: "cadre & roues",
              FahrradOhnePedale: "vélo sans pédales",
              FahrradKomplett: "vélo complet",
              KapazitätsbedarfNeu: "besoin de capacité",
              RüstzeitProVorgang: "temps d’installation par processus",
              RüstVorgänge: "procédure d'équipements",
              RüstzeitGesamt: "temps d’installation total",
              Gesamtkapazitätsbedarf: "besoin de capacité total",
              Schichten: "couches",
              Überstunden: "heures-sup.",
              Lieferzeit:"délai de livraison",
              Abweichung:"déviation",
              BenötigtFür:"nécessaire pour",
              Diskontmenge:"Diskontmenge",
              AnfangsBestand:"solde d’ouverture",
              Bedarf:"besoin",
              Bestellung:"commande",
              Menge:"quantité",
              Art:"art Normal/Eil",
              Normal:"normal",
              Pesimistisch:"pessimiste",
              Optimistisch:"optimiste",
              TitelKaufteilDisposition:"disposition d'achat",
              Periode: "période",
              ProduktionsProgramm: "programme de production",
              DropDownNormal: "normal",
              DropDownPessimistisch: "pessimiste",
              DropDownOptimistisch: "optimiste",
              localStorageDeleteButton: "sauvegarder effacer",
              PeriodeWählen: "chosir période",
              TitelExport: "exportation du fichier-XML",
              ExportSplitFalscheId:"fausse identité",
              ExportSplitKleinerNul: "doit ëtre > 0",
              ExportSplitKleinerAlsGesamt: "la valeur est > à la totalité de la commande",
              ExportSplitMax: "le produit peut ëtre séparé maximum 9 fois",
              ExportSplitHeader: "séparer les commandes",
              ExportSplitIDFloating: "Numéro d’article",
              ExportSplitIDHint: "par exemple E5",
              ExportSplitQuantityFloat: "quantité",
              ExportSplitQuantityHint: "par exemple 100",
              ExportDownloadButton: "téléchargement",
              CardIndex: "index",
              CardType: "type de produit",
              CardArticleId: "numéro d'article",
              CardMenge: "quantité",
              DropDownPeriode: "choix de la période"}}
            ]}
